...
Supports YouTube/Bilibili video download, automatic clipping, and smart collection generation
...
**Contact Email**: [christine_zhouye@163.com](mailto:christine_zhouye@163.com)
...
- **Multi-platform Support**: One-click download from YouTube, Bilibili, supports local file upload
- **AI Intelligent Analysis**: Video content understanding based on Tongyi Qianwen large language model
- **Automatic Clipping**: Intelligent recognition of exciting clips with automatic cutting, supports multiple video categories
...
- **Easy Deployment**: One-click startup scripts, Docker support, and detailed documentation
- **Bilibili Upload** [In Development]: Automatic upload of clipped videos to Bilibili
- **Subtitle Editing** [In Development]: Visual subtitle editing and synchronization functionality
...
- **Tongyi Qianwen**: AI content analysis supporting multiple models
...
cp env.example .env
# Edit .env file and fill in API keys and other configurations
```
...
- **Swagger UI**: [http://localhost:8000/docs](http://localhost:8000/docs) (local development environment)
- **ReDoc**: [http://localhost:8000/redoc](http://localhost:8000/redoc) (local development environment)
...
- Update yt-dlp version: `pip install --upgrade yt-dlp`
...
- **Frontend Interface**: [http://localhost:3000](http://localhost:3000) (local development environment)
- **Backend API**: [http://localhost:8000](http://localhost:8000) (local development environment)
- **API Documentation**: [http://localhost:8000/docs](http://localhost:8000/docs) (local development environment)
- **Flower Monitoring**: [http://localhost:5555](http://localhost:5555) (local development environment)
...
- [Tongyi Qianwen](https://tongyi.aliyun.com/) - Alibaba Cloud large language model service
...
Made with love by AutoClip Team
